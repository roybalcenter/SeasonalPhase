...
# - Oriented around summer solstice in the northern hemisphere; floating point estimation used the equinoxes and winter solstice may not have exact values of 0 and -1 
# - Ensure your column is of class Date or POSIXct. If you import from a CSV, you may need to wrap your column in as.Date(df$date_var) before passing it to the function.
...
# - Check your wave by running plot(df$date_var, df$seasonal_phase, type="l") to ensure the peaks and valleys land exactly where you expect them.
